...
namespace _44_WhyUseEventRatherDelegate
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Customer goodGuy = new Customer();
            ...
            badGuy.Order.Invoke(goodGuy, e);  // 坏人使用好人的卡付钱

            goodGuy.PayTheBill();  // 好人什么都没点，却要付钱
        }
    }
    ...
    public class Customer
    {
        ...
        public OrderEventHandler Order;  // 现在不是Event了，是委托类型的字段
